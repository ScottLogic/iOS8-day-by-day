...
class ConfigureTimerViewController: UIViewController {
  ...
  @IBAction func handleSaveButtonPressed(sender: AnyObject) {
    let string = durationTextField.text as NSString
    timerConfigDelegate?.configurationDidSetDuration(string.floatValue)
  }
